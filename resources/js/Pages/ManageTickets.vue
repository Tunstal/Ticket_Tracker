...
// Define the prop for the admin to be stored in the page
...
watch(
    ...
    debounce(function ([newCategory, newSearch]) {
        let params = { search: newSearch };
        if (newCategory) {
            params.category = newCategory;
        }
        Inertia.get("/admin/tickets", params, {
            preserveState: true,
            replace: true,
        });
    }, 300)
...
<template>
    <head>
        <title>Ticket Tracker - Manage Tickets</title>
    </head>

    <div class="flex w-full justify-center">
        <section v-if="admin.user.role === 'admin'" class="mt-10 mb-5">
            <div class="flex flex-col items-center w-full max-w-screen-lg">
                ...
                >
                    <h1 class="text-xl">Ticket Manager</h1>
                    <input
                    ...
                    <div>
                        <select
                            ...
                            class="border-2 rounded-lg p-1 mx-4 font-normal shadow-md"
                        >
                ...
                <div class="flex w-full justify-center">
                    <table class="table-fixed w-full font-normal text-center shadow-lg">
                        ...
                        <tbody class="border border-gray-400">
                            ...
                            >
                                ...
                                <td
                                    class="p-5 w-1/6 text-left overflow-hidden overflow-ellipsis whitespace-nowrap"
                                >
                                    {{ ticket.title }}
                                </td>
                                <td class="p-5 w-1/6">
                                ...
                                <td class="p-5 w-1/6 whitespace-nowrap">
                                    {{ formatDate(ticket.created_at) }}
                                </td>
                                <td
                                    class="p-5 w-1/6 text-center whitespace-nowrap"
                                >
                                ...
                                <td class="p-5 w-1/6">
                                    <Link
                                        ...
                                        class="text-sm bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-full mt-2 mb-2 shadow-md"
                                    ...
                                    <span v-if="ticket.status === 'closed'">
                                        <button
                                            ...
                                            "
                                            class="text-sm bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mb-2 w-full shadow-md"
                                            :class="{'transform transition duration-300 ease-in-out hover:scale-110': true,}"
                                        >
                                            Delete
                                        </button>
